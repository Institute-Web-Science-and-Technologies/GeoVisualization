...
Der LocationClient ist ein von Google bereitgestellter Dienst, der über den GPS Sensor (und anderen Quellen, die Google zur Verfügung stellt) die Position des Smartphones zu ermitteln. Ein weiterer Vorteil dises Dienstes ist - wie auch oben bereits erwähnt - , das dieser Dienst Akku-schonender und Zuberlässiger sei. Auch sei er zuverlässiger. Die anderen Quellen zur Positionsermittlung könnten auch zu einer genauen Positionsermittlung beitragen, wenn es eventuell Übertragungsprobleme zum GPS-Satelliten gibt.
