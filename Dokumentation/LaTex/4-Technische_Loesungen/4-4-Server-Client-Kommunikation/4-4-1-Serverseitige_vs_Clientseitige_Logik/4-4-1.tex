...
Eine Möglichkeit wäre eine serverlastige Server-Client-Architektur. Hierbei übernimmt der Server einen Großteil der Berechnungen und Logik.Bei den Clients kann man von Thin-Clients sprechen. In einer theoretischen Implementation hält der Server einen zentralen, im gültigen, Status.
...
Alternativ kann man Berechnungen und Logik vorrangig clientlastig implementieren (Fat-Clients). 
