...
Bei sinnvoller Implementation hat man deutlich weniger Aktualisierungen als bei der Push Kommunikation und benötigt daher weniger Bandbreite. 
Da für unsere Echtzeit-Spiele Aktualisierungsgeschwindigkeit enorm wichtig ist und wir so zeitnah Updates schicken wollten wie möglich, haben wir uns für die Push-Kommunikation entschieden. Wir realisieren diese Push-Kommunikation mit einem Entwurfsmuster für Server-Client-Kommunikation, dem Publish-Subscribe-Pattern (siehe vorherigen Abschnitt).
