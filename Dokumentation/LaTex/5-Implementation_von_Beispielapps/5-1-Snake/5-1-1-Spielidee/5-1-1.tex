...
für eine Mehrspieler Variante entschieden bei der in einem Spiel mehrere Zielpunkte gleichzeitig angezeigt werden, die bei Berührung den Punktestand des Spielers erhöhen und die Schlange vergrößern. Ziel des Spiels ist es schneller als die anderen eine einstellbare Anzahl von Punkten einzusammeln. Wenn man mit sich selbst oder einer anderen Schlange kollidiert wird der eigene Punktestand und die Länge der Schlange zurückgesetzt.

{\color{red}unbedingt erwähnen was chicken sind}
{\color{red}nur ein interner name für zielpunkte im code oder verstehe ich da was falsch?}